...
#sudo scutil --set ComputerName "battlestation"
...
# Use F1-12 as Function keys instead of media keys
...
/usr/libexec/PlistBuddy -c "Add com.apple.keyboard.modifiermapping.${VENDORID}-${PRODUCTID}-0:0:HIDKeyboardModifierMappingDst integer 2" ~/Library/Preferences/ByHost/.GlobalPreferences.*.plist
...
defaults write com.apple.screencapture location -string "${HOME}/Documents/Desktop"
...
# Splitscreen Lower at 30%
defaults write com.irradiatedsoftware.SizeUp SplitScreenHorizontal -int 30
